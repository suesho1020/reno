...
<main class="w-100 bg-light">
    <form method="post" action="{{route('admin.guest.update', $guest->id)}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" aria-describedby="nameError" value="{{$guest->name}}">
            <div id="nameError" class="form-text"></div>
        </div>
        <div class="mb-3">
            <label for="name" class="form-label">メールアドレス</label>
            <input type="email" class="form-control" id="email" name="email" aria-describedby="emailError" value="{{$guest->email}}">
            <div id="emailError" class="form-text"></div>
        </div>
        <div class="mb-3">
            <label for="company_name" class="form-label">会社名</label>
            <input type="text" class="form-control" id="company_name" name="company_name" aria-describedby="companyError" value="{{$guest->company_name}}">
